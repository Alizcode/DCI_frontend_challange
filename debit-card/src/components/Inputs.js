...
const Inputs = ({ state, dispatch }) => {
  ...
  const inputs = {
    ...
    message: {
      ...
      padding: "1rem",
      fontSize: "0.8rem",
      visibility: state.res ? "visible" : "hidden",
    },
  };
  ...
  return (
    <div style={inputs.main}>
      ...
      <div style={inputs.inputsDiv}>
        ...
        >
          <div
            style={{ display: "flex", flexDirection: "column", width: "31%" }}
          >
          ...
          <div
            style={{ width: "31%", display: "flex", flexDirection: "column" }}
          >
          ...
          >
            ...
            <input
              ...
              onFocus={() => dispatch({ type: "flip" })}
              onBlur={() => dispatch({ type: "flop" })}
              type="number"
              style={{
                borderRadius: "4px",
                padding: "10px",
        ...
        <div style={inputs.button}>
          <Button state={state} dispatch={dispatch} />
          <div style={inputs.message}>{state.res}</div>
        </div>
      </div>
    </div>
  );
